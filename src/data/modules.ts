...
export const moduleDefinitions: ModuleDefinition[] = [
  {
    id: "order-input", displayName: "주문서 입력기", description: "고객의 그림 조건을 생산 라인에 전달합니다.", category: "시작", price: 0, processingTime: 0, iconKey: "📜", portHint: "문서 카드",
    inputPorts: [], outputPorts: [output("order-out", "주문서", "order")], effects: [],
  },
  {
    id: "image-maker", displayName: "그림 제작기", description: "주문서를 기본 그림 초안으로 바꿉니다.", category: "생산", price: 0, processingTime: 4, iconKey: "🎨", portHint: "그림 액자",
    inputPorts: [input("order-in", "주문서", "order")], outputPorts: [output("image-out", "그림", "image")], effects: [{ tag: "generator" }],
  },
  {
    id: "style-processor", displayName: "스타일 가공기", description: "그림체와 색감 표현을 동화풍으로 바꿉니다.", category: "가공", price: 50, processingTime: 2, iconKey: "🎭", portHint: "페인트 캡슐",
  ...
  {
    id: "ban-list", displayName: "금지 목록 입력기", description: "원하지 않는 요소를 결과에서 막습니다.", category: "가공", price: 50, processingTime: 1, iconKey: "🚫", portHint: "금지 표지",
    inputPorts: [input("image-in", "그림", "image")], outputPorts: [output("image-out", "그림", "image")], effects: [{ tag: "no-hat" }],
  },
  {
    id: "composition-planner", displayName: "구도 설계기", description: "주인공의 위치와 프레임을 맞춥니다.", category: "가공", price: 75, processingTime: 2, iconKey: "⌗", portHint: "청사진",
  ...
  {
    id: "sharpener", displayName: "선명화 장치", description: "흐릿한 결과를 더 또렷하게 다듬습니다.", category: "후처리", price: 75, processingTime: 3, iconKey: "✦", portHint: "반짝이는 액자",
    inputPorts: [input("image-in", "그림", "image")], outputPorts: [output("image-out", "그림", "image")], effects: [{ tag: "sharpness", scores: { sharpness: 48 } }],
  },
  {
    id: "quality-checker", displayName: "품질 검사기", description: "문제 원인을 찾아 더 자세한 해결책을 알려 줍니다.", category: "검사", price: 100, processingTime: 1, iconKey: "🔎", portHint: "검사 증표",
    inputPorts: [input("image-in", "그림", "image")], outputPorts: [output("evaluated-out", "검사품", "evaluatedImage")], effects: [{ tag: "quality-inspection" }],
  },
  {
    id: "delivery-bay", displayName: "배송대", description: "통과한 완성품을 납품하고 보상을 받습니다.", category: "종료", price: 0, processingTime: 0, iconKey: "📦", portHint: "포장 상자",
