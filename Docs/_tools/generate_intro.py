    ...
    story = [
        ...
        table(
            [
                ...
                ["저장", "브라우저 localStorage (진행·해금·최고점)"],
            ],
            [36 * mm, 136 * mm],
        ),
        P("<b>핵심 플레이 루프</b>", "h2"),
        P(
            "손님에게서 주문서 집기 → 입력기에 넣기 → 선반에서 칩 집기 → 슬롯에 꽂기 → "
            "생산 → 출구에서 이미지 집기 → 손님에게 전달 → (목표 인원 완료) 라운드 정산"
        ),
        # --- 2. 플레이 ---
        P("2. 플레이 방법", "h1"),
        P("<b>2.1 조작</b>", "h2"),
        table(
            [
                ["키", "동작"],
                ["WASD / 방향키", "이동"],
                ["Z", "상호작용 (손님·입력기·슬롯·생산·출구·선반·바닥 물건)"],
        ...
        table(
            [
                ...
                ["입력기", "주문서를 넣어 생산 라인에 조건을 전달"],
                ["슬롯 ×3", "모듈 칩을 꽂아 파이프라인 구성. 생산 중에는 변경 불가"],
                ["생산기", "생산 시작 (슬롯에 그림 제작기 칩 필수)"],
                ["출구", "완성 이미지(폴라로이드) 수거"],
                ["선반 (하단)", "해금된 모듈 칩. 라운드당 타입 1개"],
            ],
            [40 * mm, 132 * mm],
        ),
        P("<b>2.3 튜토리얼 (r00)</b>", "h2"),
        P(
            "새 게임은 실습 튜토리얼부터 시작합니다. 안내된 순서의 상호작용만 허용되며, "
            "손님 인내심이 줄지 않아 실패 없이 한 명을 완주할 수 있습니다. "
            "완료 후 본 라운드(r01)로 이어집니다."
        ),
        P("<b>2.4 손님 · VRAM · 점수</b>", "h2"),
        bullets(
            [
                ...
                "라운드 점수는 납품 성공 · VRAM 효율 · 이탈 방어 · 예산 준수로 100점 환산 후 S~D 등급과 크레딧을 받습니다.",
                "라운드가 진행될수록 스타일·금지·구도·선명·검사 칩이 해금됩니다. 새 칩은 시작 시 모달로 소개됩니다.",
                "X로 들고 있는 결과물을 열면 조건 충족 여부와 절차적 미리보기를 확인할 수 있습니다.",
            ]
        ),
