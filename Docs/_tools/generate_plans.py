        ...
        *header_bar("3. 주방 스테이션과 생산 흐름"),
        ...
        table(
            [
                ...
                ["납품 보상", "실패 +0. 성공 +100. 통과 보너스 +50(통과 시). 인내심≥50% +20. 최대 170. 라운드 정산 크레딧과 별도."],
            ],
            [36 * mm, 136 * mm],
        ),
        PageBreak(),
        ...
        *header_bar("3. 데이터"),
        table(
            [
                ...
                ["UpgradeDefinition", "levels[], maxLevel (라운드 해금 게이트 없음·처음부터 구매 가능)"],
                ["OrderDefinition", "prompt, requiredTags, minimumScores, reward, …"],
                ["SaveData v2", "credits, completedRoundIds, unlockedModuleIds, introducedModuleIds, activeRoundId, bestRoundScores, upgradeLevels"],
            ],
            [40 * mm, 132 * mm],
        ),
        P("<b>4. 검증</b>", "h2"),
