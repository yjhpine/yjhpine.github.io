...
- 주문서 입력기와 배송대는 공장에 기본 배치됩니다. 플레이어는 중간 장치만 구성합니다.
- 왼쪽 중간 장치 카드를 클릭해 공장 중앙에 배치합니다.
- 장치를 드래그해 이동하고, 출력 포트에서 입력 포트까지 드래그해 연결합니다.
- 마우스 휠로 확대/축소하고, 빈 공간 또는 가운데 버튼으로 화면을 이동합니다.
- `Delete`로 선택 중간 장치를 삭제하고, `Ctrl+Z`로 최근 배치 또는 연결을 되돌립니다. 기본 장치는 삭제할 수 없습니다.
...
- [x] 입력기·배송대 기본 고정, 중간 장치만 배치·구성
- [x] 중간 장치 이동·삭제, 포트 연결, 취소, 되돌리기
